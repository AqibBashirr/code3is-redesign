...
function CaseStudy() {
  return (
    <section className="overflow-hidden pb-y ">
      <h2 className="text-[16.4vw] font-extrabold uppercase whitespace-nowrap leading-none  text-big-text-font">
        CASE STUDY
      </h2>
      <div className="flex flex-col-reverse md:flex-row gap-[clamp(30px,4vw,84px)] px-x mt-content-gap max-w-max mx-auto">
        <div className="casestudy-img flex-1 mt-[calc(var(--space-content)+46px)]">
        ...
        <div className="casestudy-text flex-1 ">
          ...
          <div className="main-casestudy-text mt-between-content">
            ...
            <div className="mt-content-gap">
              ...
              <div className="cards-container flex flex-col gap-5 mb-content-gap">
              ...
              <div className="flex items-center  md:justify-items-start">
